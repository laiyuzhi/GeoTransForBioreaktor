...
class Bioreaktor_Detection(Dataset):
    ...
    def __init__(self, root, resize, mode, translation_x=0.25, translation_y=0.25):
        ...
        if mode == 'Test':
            self. images_train, self.train_multi_inputs, self.labels_train = self.load_csv('vali_noGeo100.csv')
        ...
        if mode == 'Train':
            ...
            self. images_testanormal, self.testanormal_multi_inputs, self.labels_testanormal = self.load_csv('train_noGeo100.csv')
        ...
        if mode == 'Vali':
            self.images_testnormal, self.testnormal_multi_inputs, self.labels_testnormal = self.load_csv('vali_noGeo100.csv')
                ...
                for name, i in itertools.product(json_list, range(cfg.INPUT_MULTI)): # 'cat\\1.jpg'
                        ...
                        with open(os.path.join(json_path, name), 'r') as f2:
                            ...
                            if label == 1:
                                ...
                                #     multi_inputs[0] = random.uniform(multi_inputs[0]+300, 900)
                                ...
                                #     multi_inputs[0] = random.uniform(0, multi_inputs[0]-300)

                                # if multi_inputs[1] <= 25:
                                #     multi_inputs[1] = random.uniform(multi_inputs[1]+30, 90)
                                ...
                                #     multi_inputs[1] = random.uniform(0, multi_inputs[1])
                                if multi_inputs[0] <= 150:
                                    multi_inputs[0] = random.uniform(multi_inputs[0]+100, 900)
                                elif 150 <= multi_inputs[0] <= 750:
                                    list0 = [random.uniform(multi_inputs[0]+100, 900), random.uniform(0, multi_inputs[0]-100)]
                                    multi_inputs[0] = np.random.choice(list0)
                                elif multi_inputs[0] >= 750:
                                    multi_inputs[0] = random.uniform(0, multi_inputs[0]-100)

                                if multi_inputs[1] <= 15:
                                    multi_inputs[1] = random.uniform(multi_inputs[1]+10, 90)
                                elif 15 <= multi_inputs[1] <= 75:
                                    list1 = [random.uniform(multi_inputs[1]+10, 90), random.uniform(0, multi_inputs[1]-10)]
                                    multi_inputs[1] = np.random.choice(list1)
                                elif multi_inputs[1] >= 75:
                                    multi_inputs[1] = random.uniform(0, multi_inputs[1]-10)
