...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor, res_factor=10, dropRate=0.0, dropRateDense=0.1):
        ...
        # fcn resblock2
        self.fcnblock2 = MLP_Group(MLPblock, fcnChannels[2] + fcnChannels[2], fcnChannels[1], 1, dropRateDense)
        self.out_early = nn.Linear(fcnChannels[1], num_classes)
        nn.init.kaiming_uniform_(self.out_early.weight)
        # fcv resblock3
        self.fcnblock3 = MLP_Group(MLPblock, fcnChannels[2] + fcnChannels[1] + fcnChannels[2], fcnChannels[1], 1, dropRateDense)
